function feat = feat_from_lpc(vq, nCentroids)
    ...
    for i = 1:nCentroids
        feat(1,i) = (fftx(5,i)-fftx(6,i))/sum(fftx(:,i));
        %feat(1,i) = (fftx(5,i)-fftx(6,i));
    end
    %Segundo feature
    for i = 1:nCentroids
        feat(2,i) = (fftx(6,i)-fftx(7,i))/sum(fftx(:,i));
        %feat(2,i) = (fftx(6,i)-fftx(7,i));
    end
    
    for i = 1:nCentroids
        feat(3,i) = (fftx(7,i)-fftx(8,i))/sum(fftx(:,i));
        %feat(3,i) = (fftx(7,i)-fftx(8,i));
    end
%     for i = 1:nCentroids
