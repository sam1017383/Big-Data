function z = lbg2(points, maxcodebooksize)
    ...
    while (maxcodebooksize > length(codebook(:,1)))
        ...
        %NUmero maximo de veces que intentará estabilizar los centroides
        epsilon = 400;
